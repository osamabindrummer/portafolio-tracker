    ...
    "racional": {
        ...
        "holdings": [
            HoldingConfig(
                ...
                display_name="Racional CFIETFGE",
                currency="CLP",
            ),
            HoldingConfig(
                ticker="IYWCL.SN",
                ...
                display_name="iShares U.S. Technology (CL)",
                currency="CLP",
            ),
            HoldingConfig(
                ticker="EEMCL.SN",
                ...
                display_name="iShares MSCI Emerging Markets (CL)",
                currency="CLP",
            ),
            HoldingConfig(
                ...
                display_name="Racional CFMITNIPSA",
                currency="CLP",
            ),
            HoldingConfig(
                ticker="CFIETFCC.SN",
                ...
                display_name="Racional CFIETFCC",
                currency="CLP",
            ),
            HoldingConfig(
                ticker="CFMDIVO.SN",
